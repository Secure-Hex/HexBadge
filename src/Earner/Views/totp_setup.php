...
<div style="max-width:520px">
    <p><strong>1.</strong> Abrí tu app de autenticación (Google Authenticator, Authy…) y agregá una cuenta.</p>
    ...
    <p style="margin-top:.5rem">En el móvil: <a href="<?= e($uri) ?>">Abrir en la app</a></p>

    <p style="margin-top:1.5rem"><strong>3.</strong> Ingresá el código de 6 dígitos:</p>
    <form method="POST" action="/me/security/totp" autocomplete="off" style="max-width:280px">
        <?= CSRF::field() ?>
    ...
    <p style="margin-top:1rem"><a href="/me/security">Cancelar</a></p>
</div>
